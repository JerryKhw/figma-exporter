                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex gap-2">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        <div className="px-2 py-1.5 text-xs font-medium text-gray-500 pointer-events-none border-b border-gray-100">
                                            Format
                                        </div>
                                        {formatList.map((item) => (
                                            <SelectItem
                                    ...
                                    <CustomTooltip content="Set compression quality (1-100%)">
                                        <div className="relative w-16">
                                            <Input
                                                ...
                                                className="h-7 text-xs text-center pr-4 focus:outline-hidden focus:ring-0 focus:border-gray-400"
                                            />
                            ...
                            <div className="flex gap-2">
                                <CustomTooltip content="Add a prefix to all exported file names">
                                    <Input
                                        ...
                                        placeholder="Prefix"
                                        className="w-20 h-7 text-xs focus:outline-hidden focus:ring-0 focus:border-gray-400"
                                    />
                                </CustomTooltip>
                                <CustomTooltip content="Add a suffix to all exported file names">
                                    <Input
                                        ...
                                        placeholder="Suffix"
                                        className="w-24 h-7 text-xs focus:outline-hidden focus:ring-0 focus:border-gray-400"
                                    />
                                </CustomTooltip>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-2">
                            ...
                            <div className="relative">
                                <div className="flex">
                                    <Button
                                        size="sm"
                                        className="h-8 px-4 bg-black hover:bg-gray-800 border-gray-600"
                                        onClick={onExport}
                                        disabled={isLoading}
                                    >
